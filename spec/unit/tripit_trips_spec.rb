  ...
  context "When querying for trips" do
    it "Should return all trips with summarized information within them", :unit do
      ...
      expected_responses_from_tripit = {
        ...
        "/get/trip/123456789/includeObjects/true": 'sample_personal_trip.json',
        "/get/trip/293554303/includeObjects/true": 'sample_trip_without_flights.json',
        "/get/trip/293554133/includeObjects/true": 'sample_trip_with_flights.json'
      }
