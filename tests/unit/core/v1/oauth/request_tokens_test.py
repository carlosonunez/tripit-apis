"""
Tests for generating TripIt v1 OAuth request tokens.
"""
import os
import datetime
import secrets
...
from tripit.core.v1.oauth import (
...
def test_getting_oauth_request_tokens(monkeypatch):
    ...
    assert request_request_token() == {"token": fake_token, "token_secret": fake_token_secret}
